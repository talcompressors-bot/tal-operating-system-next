...
1. AI Draft Preview runtime capability for Service Report `5806`, read-only/no-write first, if Liad wants to continue the evidence-to-draft path.
2. Working UI capability that advances Wave 2 workflow.
3. Action Server capability, when explicitly selected and scoped safely.
4. Email Runtime capability, when explicitly selected and approved.
5. Inventory Runtime capability, when explicitly selected and approved.
