...
1. AI Draft Recommendation Preview runtime/shell mission packet for Service Report `5806`, read-only and no-write, if Liad wants to continue the evidence-to-draft path.
...
4. Optional Wave 2 import approval package, only if explicitly approved.
