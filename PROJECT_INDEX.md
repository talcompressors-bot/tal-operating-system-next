...
| Last Implementation Commit | `5313aec Improve autonomous business draft generation` | Git history; `project-brain/CURRENT_TASK.md` |
...
- Current Task: Project sync truth reconciliation is active; Production Draft Generation maintenance quality fix was committed in `77cf9cd`, Drive mirror setup was committed in `7310ddf`, the working tree is clean, and no uncommitted runtime maintenance files remain. Sync files summarize state/delta/agents/tasks/authority/operating rules for ChatGPT Project Sources, and maintenance drafts keep standard maintenance parts visible as review-required lines when exact part/price evidence is incomplete.
...
| Current task | Project sync truth reconciliation is active; Production Draft Generation maintenance quality fix was committed in `77cf9cd`, Drive mirror setup was committed in `7310ddf`, the working tree is clean, and no uncommitted runtime maintenance files remain. Sync files summarize current state, latest delta, agents/tools/skills, tasks, authority, and operating guide for ChatGPT Project Sources. Maintenance drafts detect Small Service from 2000/2500 hour evidence and Large Service from 4000/5000 hour evidence, add standard maintenance parts as separate reviewable lines even when exact part/price evidence is incomplete, and keep the customer-facing preview/PDF simple. Real Maven execution, receipt issuing, OCR, bank API, saved PDF persistence, customer delivery/export, inventory action, schema changes, DB imports, parser implementation, parser package installs, LibreOffice install/conversion, and new npm package installs without package-specific approval are not approved | `project-brain/CURRENT_TASK.md`, `project-brain/TASK_BOARD.md`, `project-brain/DECISION_LOG.md`, `APPLICATION_ROUTE_MAP.md`, `PROJECT_SYNC_STATE.md`, `PROJECT_SYNC_DELTA.md`, `PROJECT_SYNC_AGENTS.md`, `PROJECT_SYNC_TASKS.md`, `PROJECT_SYNC_AUTHORITY.md`, `PROJECT_SYNC_OPERATING_GUIDE.md` |
