...
- Wave 2 Workflow Layer: 3% / 15% CURRENT
...
Current estimated completion: 53%.

This estimate is valid because the first four capabilities are complete by Project Brain evidence and the Wave 2 read-only Equipment and PartsUsed modules are now implemented. If any of those capabilities are later found partial, estimate lower and explain why.
