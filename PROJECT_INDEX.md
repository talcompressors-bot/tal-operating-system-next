...
| Last Implementation Commit | `36299a8 Add business document draft gateway` | Git history; `project-brain/CURRENT_TASK.md` |
...
- Current Task: Generalized BusinessDocument Draft Gateway Sprint 8 complete; `/business-cases/service-report/[id]` can now create one internal BusinessDocument draft for current-schema document types after explicit confirmation and ServiceReport + DocumentType idempotency.
- Last Completed Task: Generalized BusinessDocument Draft Gateway Sprint 8
...
- Wave 3 Commercial Runtime and Document Engine: 12% / 15% STARTED INTERNAL
...
- Completion formula: 15 + 15 + 10 + 10 + 15 + 12 + 1 + 0 + 0 + 0 = 78.
